    ...
    request.onload = function() {
      if (request.status >= 200 && request.status < 400) {
        ...
        lunr.tokenizer.separator = {
          {
            site.search.tokenizer_separator |
              default: site.search_tokenizer_separator |
              default: "/[\s\-/]+/"
          }
        }
    ...
    function update() {
      ...
      function addResult(resultsList, result) {
        ...
        for (var j in metadata) {
          ...
          if (meta.content) {
            ...
            for (var k in positions) {
              ...
              for (var k = 0; k < {
                  {
                    site.search.preview_words_before |
                      default: 5
                  }
                }; k++) {
              ...
              for (var k = 0; k < {
                  {
                    site.search.preview_words_after |
                      default: 10
                  }
                }; k++) {
        ...
        if (contentPositions.length > 0) {
          ...
          for (var j = 0; j < Math.min(previewPositions.length, {
              {
                site.search.previews |
                  default: 3
              }
            }); j++) {
